...
public class Align : SteeringBehavior
{
    ...
    public override SteeringOutput getSteering()
    {
        ...
        {
            targetRotation = character.maxAngularVelocity; // <-- USED character.maxAngularVelocity
        }
        else // otherwise use a scaled rotation
        {
            targetRotation = character.maxAngularVelocity * rotationSize / slowRadius; // <-- USED character.maxAngularVelocity
        }
